      ...
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <button
            ...
            className="group lg:col-span-2 block text-left w-full"
          >
            <div className="relative rounded-xl overflow-hidden bg-slate-900 aspect-video mb-3">
              {principal.imagen_url ? (
                <Image
                  ...
                  fill
                  className="object-cover opacity-90 group-hover:opacity-70 group-hover:scale-105 transition-all duration-300"
                />
              ) : (
            ...
            <h3 className="font-heading text-xl font-bold leading-snug group-hover:text-primary-600 transition-colors line-clamp-2">
              {principal.titulo}
            </h3>
            ...
            <div className="flex flex-col divide-y divide-slate-100 dark:divide-slate-800">
              {resto.slice(0, 3).map(video => (
                <button
                  ...
                  className="group flex gap-3 py-3 first:pt-0 last:pb-0 text-left w-full"
                >
                  ...
                  <div className="flex-1 min-w-0 py-0.5">
                    ...
                    <h4 className="font-heading text-sm font-semibold line-clamp-2 leading-snug group-hover:text-primary-600 transition-colors">
                      {video.titulo}
                    </h4>
